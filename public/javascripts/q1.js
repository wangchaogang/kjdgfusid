...
;(function ($) {
    $.fn.lrkf = function (options) {
        ...
        //插入html结构和基础css
        if(!$("#lrkfwarp").length){
           $('#qqd').html("<div id='lrkfwarp' class='lrkf lrkf-"+opts.direction+" lrkfshow' style="+opts.position+"><div class='lrkf_box'><div class='lrkf_con'><ul class='kflist'></ul></div></div></div>");
